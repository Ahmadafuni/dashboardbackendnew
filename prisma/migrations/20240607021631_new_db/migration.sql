...
-- CreateEnum
CREATE TYPE "RunningStatus" AS ENUM ('RUNNING', 'PUASED');
...
-- CreateEnum
CREATE TYPE "DepartmentCategory" AS ENUM ('CUTTING', 'DRAWING', 'ENGINEERING', 'FACTORYMANAGER', 'PRINTING', 'QUALITYASSURANCE', 'TAILORING', 'WAREHOUSEMANAGER');
...
CREATE TABLE "TrakingModels" (
    ...
    "RunningStatus" "RunningStatus" NOT NULL DEFAULT 'RUNNING',
    "QuantityReceived" INTEGER,
    "QuantityDelivered" INTEGER,
    "DamagedItem" INTEGER DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "TrakingModels" ADD CONSTRAINT "TrakingModels_PrevStageId_fkey" FOREIGN KEY ("PrevStageId") REFERENCES "ManufacturingStages"("Id") ON DELETE SET NULL ON UPDATE CASCADE;
